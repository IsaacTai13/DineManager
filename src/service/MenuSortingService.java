 ...
 * Provides Merge Sort algorithm and comparators for menu items
 */
public class MenuSortingService {
    ...
    // ============================================================
    // Sorting Methods with Timing for Controllers
    // ============================================================
    ...
    private static SortResult sortWithTiming(List<MenuItem> items, Comparator<MenuItem> comparator) {
        ...
        List<MenuItem> result = mergeSort(items, comparator);
